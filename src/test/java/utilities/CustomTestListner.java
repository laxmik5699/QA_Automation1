...
public class CustomTestListner  implements ITestListener {
    ...
    public void onTestSuccess(ITestResult result) {
        System.out.println("Test passed: " + result.getTestClass().getName() +
                " -- " + result.getMethod().getMethodName());
    }

    @Override
    public void onTestFailure(ITestResult result) {
        System.out.println("Test failed: " + result.getTestClass().getName() +
                " -- " + result.getMethod().getMethodName());
    }
